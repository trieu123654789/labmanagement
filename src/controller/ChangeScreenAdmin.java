...
import frame.admin.Feedback;
import frame.admin.Batch;
import frame.admin.Lab;
import frame.admin.LearningReport;
import frame.admin.Schedule;
import frame.admin.Students;
import frame.admin.Technology;


public class ChangeScreenAdmin {

    private JPanel root;
    private String kindSelected = "";
    private List<Bean> listItem = null;

    public ChangeScreenAdmin(JPanel jpnRoot) {
        this.root = jpnRoot;
    }
